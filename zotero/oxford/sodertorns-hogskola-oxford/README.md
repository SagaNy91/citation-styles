# Guide till Södertörns högskolas Oxford-stil
...
* eventuellt lagstiftande organ: Utbildningsdepartementet
* URL-länk och åtkomstdatum (om materialet har hämtats från internet).
...
* arkiv
* arkivort (om materialet inte har hämtats från internet)
* URL-länk och åtkomstdatum (om materialet har hämtats från internet).

Referensen i referenslistan och första fotnot blir då:

von Linné, Carl, *Letter 22 August 1748, Uppsala to Jean François Séguier, Verona. L0942*, [brev], 1748, Linnaean correspondence, Uppsala universitetsbibliotek, http://urn.kb.se/resolve?urn=urn:nbn:se:alvin:portal:record-224468 [hämtad 2024-07-30].

…och i förkortad fotnot:

von Linné, *Letter 22 August 1748, Uppsala to Jean François Séguier, Verona. L0942*. 
# Guide to the Södertörn University Oxford style
## Introduction
This documentation guides how you use the Zotero style Södertörns högskola - Oxford. You can find the style and download it from the Zotero style repository: http://www.zotero.org/styles/sodertorns-hogskola-oxford 
...
* Title (will be in italics): Personuppgiftslag
* short title (if any)
* public law number: SFS 1998:204
...
* Title (will be in italics): Självständiga lärosäten: Betänkande av autonomiutredningen
* short title (if any)
* bill number: SOU 2008:104
* legislative authority (if any): Utbildningsdepartementet
* URL and access date (if the material has been accessed online).
...
* archive
* archive place (if not accessed online)
* URL link and date of access (if the material has been accessed online).

The first note and reference in the reference list will then be:

von Linné, Carl, *Letter 22 August 1748, Uppsala to Jean François Séguier, Verona. L0942*, [letter], 1748, Linnaean correspondence, Uppsala University Library, http://urn.kb.se/resolve?urn=urn:nbn:se:alvin:portal:record-224468 [accessed 2024-07-30].
